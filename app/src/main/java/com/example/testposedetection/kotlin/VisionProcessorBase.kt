...
import com.example.testposedetection.detectionAndCamera.*
...
abstract class VisionProcessorBase<T>(context: Context) :
  ...
  private fun processImage(
    ...
    val bitmap =
      ...
      else com.example.testposedetection.detectionAndCamera.BitmapUtils.getBitmap(data, frameMetadata)
  ...
  override fun processImageProxy(image: ImageProxy, graphicOverlay: GraphicOverlay) {
    ...
    if (!PreferenceUtils.isCameraLiveViewportEnabled(graphicOverlay.context)) {
      bitmap = com.example.testposedetection.detectionAndCamera.BitmapUtils.getBitmap(image)
    }
